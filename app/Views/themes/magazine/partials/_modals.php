                                ...
                                <div class="item">
                                    <div class="item-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" version="1.1">
                                            ...
                                            <path d="" stroke="none" fill="#288ce4" fill-rule="evenodd" />
                                            <path d="M 8.364 3.170 C 4.711 4.939, 4 8.331, 4 24 C 4 39.963, 4.696 43.085, 8.657 44.890 C 11.853 46.346, 36.147 46.346, 39.343 44.890 C 43.304 43.085, 44 39.963, 44 24 C 44 8.037, 43.304 4.915, 39.343 3.110 C 36.267 1.709, 11.282 1.757, 8.364 3.170 M 13 12 C 13 12.556, 15.667 13, 19 13 C 22.333 13, 25 12.556, 25 12 C 25 11.444, 22.333 11, 19 11 C 15.667 11, 13 11.444, 13 12 M 13 20 C 13 20.606, 17.333 21, 24 21 C 30.667 21, 35 20.606, 35 20 C 35 19.394, 30.667 19, 24 19 C 17.333 19, 13 19.394, 13 20 M 13 28 C 13 28.606, 17.333 29, 24 29 C 30.667 29, 35 28.606, 35 28 C 35 27.394, 30.667 27, 24 27 C 17.333 27, 13 27.394, 13 28 M 13 36 C 13 36.606, 17.333 37, 24 37 C 30.667 37, 35 36.606, 35 36 C 35 35.394, 30.667 35, 24 35 C 17.333 35, 13 35.394, 13 36" stroke="none" fill="#248ce4" fill-rule="evenodd" />
                                        </svg>
                                    </div>
                                    <h5 class="title">Epaper</h5>
                                </div>
                            </a>
                        </div>
                    </div>
