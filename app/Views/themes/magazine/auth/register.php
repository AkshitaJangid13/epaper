                ...
                <div class="display-flex align-items-center justify-content-center">
                    <div class="section-account">
                        ...
                        <form action="<?= base_url('register-post'); ?>" method="post" class="needs-validation">
                            ...
                            <div class="mb-2">
                                <input type="number" name="mobile" class="form-control form-input input-account" placeholder="Mobile" value="<?= old("mobile"); ?>" required >
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-3">
                                <!--<label for="pet-select">Choose designation:</label>-->

                                <select name="designation" id="designation" onchange="toggleTextBox()" class="form-control form-input input-account">
                                    <option value="hide">Choose designation</option>
                                    <option value="unhide">Editor</option>
                                    <option value="unhide">संपादक</option>
                                    <option value="hide">Other</option>
                                </select>
                            </div>
                            <div class="mb-2 hidden" id="textboxDiv">
                                <input type="text" name="rni_number" class="form-control form-input input-account" placeholder="RNI Number" value="<?= old("RNI Number"); ?>">
                            </div>
...
<script>
    function toggleTextBox() {
      var selection = document.getElementById("designation").value;
