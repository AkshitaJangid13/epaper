                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control form-input" name="rni_number" placeholder="<?= trans('RNI Number'); ?>" value="<?= esc($user->rni_number); ?>">
                    </div>
                     <div class="form-group">
                        <label>Mobile</label>
                        <input type="text" class="form-control form-input" name="mobile" placeholder="<?= trans('mobile'); ?>" value="<?= esc($user->mobile); ?>">
                    </div>
